# WSGM 2.0 detailed requirements matrix

> **Archived as an execution tracker on 2026-08-28.** This file preserves the exhaustive `INV-*`
> and `P0-*` through `P10-*` requirements used by design decisions, tests, and generated
> traceability. It is not a percentage-complete checklist and should not be updated for ordinary
> progress. Track current work in [`implementation-todo.md`](./implementation-todo.md); change this
> matrix only when the underlying requirement itself changes.
