...
$source = Join-Path $root "src\WSGM.Device.HandheldCompanion"
$project = Join-Path $source "WSGM.Device.HandheldCompanion.csproj"
...
$workMarkerValue = "hc-package-work-v1"
$restoreArguments = @()
if ($NoRestore) {
...
$archiveMarkerValue = "hc-package-output-v1|$packageId|$packageVersion"
