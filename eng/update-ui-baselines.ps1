...
param(
    [Parameter(Mandatory)]
    [ValidatePattern('^(overlay-(quick-access|device-core|device-plugin|steam|tools|power|keyboard|power-menu|profiles)-(980|1280|1920|720p|720p-scaled|4k|4k-scaled)|overlay-(display|widgets|plugins|sections)-1280|settings-(system|quick-access|appearance|display-custom)-(1024|1280))$')]
    [string[]]$Case
)
