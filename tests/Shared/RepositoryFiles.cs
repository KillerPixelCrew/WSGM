...
/// <remarks>Linked into several test projects, so a missing checkout throws a plain exception
/// instead of using a test-framework assertion.</remarks>
    ...
    internal static string Root
    {
        get
        {
            ...
            return directory?.FullName
                ?? throw new DirectoryNotFoundException("Run the tests from a WSGM checkout; no WSGM.slnx was found above the test output.");
        }
    }
