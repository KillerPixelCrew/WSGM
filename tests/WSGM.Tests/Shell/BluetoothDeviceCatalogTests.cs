...
public sealed class BluetoothDeviceCatalogTests
{
    ...
    public void RemovingOneTransportDoesNotDisconnectTheOther()
    {
        ...
        var rows = catalog.Apply(WindowsRadio.BluetoothChangeKind.Removed,
            new WindowsRadio.BluetoothDevice("classic", "", false, false, false, ""));
    ...
    public void ConfirmedUnpairDoesNotLeaveARetainedPairedGhost()
    {
        ...
        Assert.Empty(catalog.Apply(WindowsRadio.BluetoothChangeKind.Removed,
            new WindowsRadio.BluetoothDevice("paired", "", false, false, false, "")));
    }
    ...
    {
        return catalog.Apply(WindowsRadio.BluetoothChangeKind.Added,
            new WindowsRadio.BluetoothDevice(id, "Controller", paired, canPair, connected, container));
    }
}
