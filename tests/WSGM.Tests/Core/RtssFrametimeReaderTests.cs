...
public sealed class RtssFrametimeReaderTests
{
    ...
    public void AOneFramePerSecondApplicationReportsAThousandMillisecondMean()
    {
        ...
        region.WriteEntry(0, 5552, @"C:\Program Files\RustDesk\RustDesk.exe",
            41_237_921, 41_239_921, 2);

        var sample = Assert.Single(
            RtssFrametimeReader.Parse(region, 41_240_156, out var incompatible));
    ...
    {
        FakeRegion region = new();
        region.WriteEntry(0, 900, @"D:\Games\game.exe", 1_000_000, 1_001_000, 60);
    ...
    public void ProfileOnlyEntriesWithoutTimingAreIgnored()
    {
        ...
        region.WriteEntry(1, 1235, @"C:\Tools\Other.exe", 500, 0, 4);
    ...
    public void OnlyRenderingEntriesAreReturnedFromAMixedTable()
    {
        ...
        region.WriteEntry(1, 2, @"C:\live.exe", 9_000, 9_100, 10);
        region.WriteEntry(2, 3, @"C:\stale.exe", 1_000, 1_100, 10);
    ...
    public void ATickCounterWrapDoesNotProduceAHugeAge()
    {
        ...
        region.WriteEntry(0, 7, @"C:\game.exe", 40, 140, 10);
    ...
    {
        FakeRegion region = new();
        region.WriteEntry(0, 7, @"C:\game.exe", 5_000, 6_000, 10);
    ...
    public void EntriesRunningPastTheMappedRegionAreNotRead()
    {
        ...
        FakeRegion region = new(ArrayOffset + EntrySize + 16);
        region.WriteUInt32(16, 64);
        region.WriteEntry(0, 5, @"C:\one.exe", 100, 200, 10);
    ...
    private sealed class FakeRegion : IRtssRegion
    {
        ...
        {
            return BitConverter.ToUInt32(_bytes, checked((int)offset));
        }
