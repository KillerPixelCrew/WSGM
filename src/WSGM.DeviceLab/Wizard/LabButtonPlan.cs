    ...
    public static IReadOnlyList<LabControl> For(DeviceKnowledgeRecord? record)
    {
        ...
        [
            ...
            new("rt", "Right trigger (RT)", "Press the right trigger slowly all the way in, then let it go.", false,
                Detailed: true, QuietMs: 900),
            new("left-stick", "Left stick", "Move the left stick slowly all the way round twice, then let it go.", false,
                Detailed: true, QuietMs: 900),
        ...
        [
            ...
            Extra("back-left1", "Back button, left (upper or only)", "If there is a button on the back, left side, press and release it. If there are two, use the upper one."),
            Extra("back-left2", "Back button, left (lower)", "If there is a second button on the back, left side, press and release it."),
            Extra("back-right1", "Back button, right (upper or only)", "If there is a button on the back, right side, press and release it. If there are two, use the upper one."),
            Extra("back-right2", "Back button, right (lower)", "If there is a second button on the back, right side, press and release it."),
            Extra("touchpad-left-click", "Left touchpad click", "If there is a touchpad on the left, press it down until it clicks, then let go."),
            Extra("touchpad-left-surface", "Left touchpad surface", "Slide your finger across the left touchpad, then lift it.", true),
            Extra("touchpad-right-click", "Right touchpad click", "If there is a touchpad (or the only touchpad) on the right, press it down until it clicks, then let go."),
            Extra("touchpad-right-surface", "Right touchpad surface", "Slide your finger across the right touchpad, then lift it.", true),
            Extra("stick-touch-left", "Left stick touch", "Rest your thumb on the left stick without moving it, then lift it.", true),
            Extra("stick-touch-right", "Right stick touch", "Rest your thumb on the right stick without moving it, then lift it.", true),
