...
internal static class InventoryRedaction
{
    ...
    public static MachineInventory ToShareable(MachineInventory inventory, CaptureRedactor redactor)
    {
        ...
        var shareable = inventory with
        {
            GraphicsAdapters =
            [
                .. inventory.GraphicsAdapters.Select(adapter => adapter with
                {
            ...
            UsbInterfaces =
            [
                .. inventory.UsbInterfaces.Select(i => i with
                {
            ...
            SerialEndpoints =
            [
                .. inventory.SerialEndpoints.Select(endpoint => endpoint with
                {
            ...
            Sensors =
            [
                .. inventory.Sensors.Select(sensor => sensor with
                {
            ...
            InputBackends =
            [
                .. inventory.InputBackends.Select(backend => backend with
                {
                    Endpoints =
                    [
                        .. backend.Endpoints.Select(endpoint => endpoint with
                        {
            ...
            Processes =
            [
                .. inventory.Processes.Select(process => process with
                {
            ...
            Services =
            [
                .. inventory.Services.Select(service => service with
                {
            ...
            ScheduledTasks =
            [
                .. inventory.ScheduledTasks.Select(task => task with
                {
            ...
            Providers =
            [
                .. inventory.Providers.Select(provider => provider with
                {
            ...
            TopologyGenerations =
            [
                .. inventory.TopologyGenerations.Select(observation => observation with
                {
    ...
    private static string? Tokenize(CaptureRedactor redactor, string? value)
    {
