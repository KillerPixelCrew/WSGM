...
/// ("Never notify"): admins auto-elevate silently, which is what lets OpenFSE start
...
/// short-lived elevated instance of OpenFSE — one prompt to silence future ones.</summary>
public static class UacSettings
{
    ...
    /// <summary>Requests the change from the non-elevated UI: relaunches OpenFSE
