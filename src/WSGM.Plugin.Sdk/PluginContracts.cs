...
public sealed record PluginHealthPublication(
    PluginInstanceIdentity Instance,
    long Generation,
    PluginHealth Health,
    string? Detail);
...
public interface IPlugin : IAsyncDisposable
{
    ...
    ValueTask SuspendAsync(PluginContext context, CancellationToken cancellationToken)
    {
    ...
    ValueTask ResumeAsync(PluginContext context, CancellationToken cancellationToken)
    {
        return ValueTask.CompletedTask;
    }
