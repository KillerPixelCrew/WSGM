...
public sealed record PluginConfiguration(
    ...
    IReadOnlyDictionary<string, PluginValue> Values);
...
public sealed record PluginConfigurationResult(
    long Revision,
    PluginConfigurationOutcome Outcome,
    string? Detail = null);
...
public interface IConfigurablePlugin
{
    ...
    ValueTask<PluginConfigurationResult> ConfigureAsync(PluginConfiguration configuration, PluginContext context,
...
public static class PluginConfigurationRules
{
    ...
    public static bool Accepts(PluginSetting setting, PluginValue value)
    {
        return value.IsValid && setting.Kind switch
        {
            ...
            PluginSettingKind.Number => value.Number.HasValue && !(value.Number < setting.Minimum) &&
                                        !(value.Number > setting.Maximum),
