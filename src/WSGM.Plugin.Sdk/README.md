...
The existing Device SDK and device runtime remain operational. Their compatibility adapter follows
in the next slice. Configuration/events, actions/UI contributions, packaging tooling and a real
...
`IPlugin` starts with a host-owned instance/generation context, receives Desktop/Game transitions,
