...
public interface IPluginActions
{
    ...
    ValueTask<PluginActionResult> ExecuteActionAsync(PluginActionRequest request, PluginContext context,
...
/// <remarks>
///     State updates and commands use the normal plugin publication/action contracts. Missing
///     predicate state means unavailable. Hosts retain a placeholder for a pinned unavailable widget.
/// </remarks>
public sealed record PluginWidget(
    string Id,
    string Label,
    IReadOnlyList<string> ContributionIds,
    string? Icon = null,
    string? SecondaryStateKey = null,
    string? VisibleStateKey = null,
    string? EnabledStateKey = null,
