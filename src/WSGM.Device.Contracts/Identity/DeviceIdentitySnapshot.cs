...
public sealed record UsbEndpointObservation
{
    ...
    /// </summary>
    /// <remarks>
    /// Deliberately absent from <see cref="IdentitySignal"/> and therefore unusable as a manifest
    /// predicate. A location path describes which port a device is plugged into on *this* machine and
