...
{
    /// <summary>Oldest protocol version the host supports.</summary>
    public required ushort MinProtocolVersion { get; init; }

    /// <summary>Newest protocol version the host supports.</summary>
    public required ushort MaxProtocolVersion { get; init; }

    /// <summary>Fingerprint of the compiled semantic contracts.</summary>
    ...
    /// <summary>Fresh host generation assigned by the coordinator.</summary>
...
public sealed record DeviceHostHelloAck
{
    ...
    /// <summary>Protocol negotiation result.</summary>
    public required NegotiationResult Negotiation { get; init; }

    /// <summary>Agreed protocol version, or zero on refusal.</summary>
...
public sealed record DeviceActivateRequest
{
    ...
    /// <summary>Unresolved plugin-owned recovery records from the previous host.</summary>
...
public sealed record DeviceDeactivateRequest
{
    /// <summary>Why the device cycle is ending.</summary>
    public required DeviceDeactivationReason Reason { get; init; }
...
[JsonConverter(typeof(JsonStringEnumConverter<DeviceDeactivationReason>))]
public enum DeviceDeactivationReason
{
...
public sealed record DeviceLifecycleNotification
{
    ...
    /// <summary>Host generation producing the notification.</summary>
    public required long HostGeneration { get; init; }
...
/// <summary>Wire form of one independently owned resource state.</summary>
public sealed record DeviceResourceStateNotification
{
    ...
    /// <summary>Why the resource is unavailable or degraded.</summary>
    public CapabilityReason? Reason { get; init; }

    /// <summary>Device generation this observation describes.</summary>
    public required long DeviceGeneration { get; init; }
}
