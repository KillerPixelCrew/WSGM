...
/// <see cref="CapabilityProjection"/> and are never mixed in here — a plugin does not own what the
/// user asked for.
/// </remarks>
public sealed record CapabilityState
{
    ...
    /// <summary>Device generation this state was produced against.</summary>
