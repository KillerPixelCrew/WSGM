...
public enum CapabilityReasonCode
{
    ...
    /// <summary>Blocked by a mutually exclusive capability that is currently active.</summary>
    MutuallyExclusive,

    /// <summary>The transport failed and the capability is quarantined until recovery.</summary>
    TransportFaulted,
