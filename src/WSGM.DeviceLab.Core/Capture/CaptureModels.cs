...
/// <summary>Version numbers and hard bounds for Device Lab capture artifacts.</summary>
public static class CaptureSchema
{
    /// <summary>Current private working-capture manifest version.</summary>
    public const int PrivateManifestVersion = 1;

    /// <summary>Current sanitized <c>.wsgmcap</c> manifest version.</summary>
    public const int ShareableManifestVersion = 1;

    /// <summary>Current observe-only recipe version.</summary>
    public const int RecipeVersion = 1;

    /// <summary>Current stream-event version.</summary>
    public const int StreamEventVersion = 1;

    /// <summary>Current analysis-result version.</summary>
    public const int AnalysisResultVersion = 1;

    /// <summary>Current redaction-manifest version.</summary>
...
public enum CapturePrivacy
{
    /// <summary>Unredacted local evidence that must never be exported as a <c>.wsgmcap</c>.</summary>
    PrivateWorking,

    /// <summary>Redacted evidence explicitly prepared for sharing.</summary>
    ShareableSanitized,
}
...
/// </summary>
public sealed record PrivateCaptureManifest
{
    ...
    /// <summary>Recipe stored as inert evidence of the steps that ran.</summary>
    ...
    /// <summary>Claim ledger path.</summary>
    public required string ClaimsPath { get; init; }
...
public sealed record ShareableCaptureManifest
{
    /// <summary>Schema version of this manifest.</summary>
    public required int SchemaVersion { get; init; }
    ...
    /// <summary>Explicit proof that this manifest describes the shareable projection.</summary>
    ...
    /// <summary>Path of the evidence claim ledger.</summary>
    public string ClaimsPath { get; init; } = CaptureBundleLayout.ClaimsPath;
...
public sealed record CaptureStreamDescriptor
{
...
public sealed record CaptureAnalysisDescriptor
{
...
public sealed record CaptureBlobDescriptor
{
...
/// <summary>An inert record of the observe-only steps a capture performed.</summary>
/// <remarks>
/// A recipe found in an imported bundle is evidence only. It is not an executable probe definition
/// and cannot supply or authorize a hardware write.
/// </remarks>
public sealed record ObserveOnlyRecipe
{
    ...
    /// <summary>Authority marker that always identifies imported recipe data as inert.</summary>
    public RecipeAuthority Authority { get; init; } = RecipeAuthority.InertEvidence;

    /// <summary>Ordered observation steps.</summary>
    public IReadOnlyList<ObservationStep> Steps { get; init; } = [];
}

/// <summary>The only authority an observe-only capture recipe can carry.</summary>
[JsonConverter(typeof(JsonStringEnumConverter<RecipeAuthority>))]
public enum RecipeAuthority
{
    /// <summary>Evidence of what ran; never executable authority.</summary>
    InertEvidence,
}

/// <summary>One bounded observation or operator marker in a capture recipe.</summary>
public sealed record ObservationStep
{
...
public enum ObservationStepKind
{
...
public sealed record CaptureSourceTimestamp
{
...
public sealed record CaptureStreamEvent
{
    /// <summary>Schema version of this event.</summary>
    public required int SchemaVersion { get; init; }

    /// <summary>Stable identifier used by analyses and claims.</summary>
...
public enum EventDiscontinuity
{
...
public sealed record CaptureAnalysisValue
{
...
public sealed record CaptureRedactionManifest
{
...
public sealed record QuarantinedCaptureArtifact
{
...
public sealed record CaptureHashEntry(string Path, string Sha256);

/// <summary>An in-memory raw-event stream ready for sanitized bundle writing.</summary>
public sealed record CaptureStreamFile
{
...
public sealed record CaptureAnalysisFile
{
...
public sealed record CaptureBlobFile
{
...
public sealed record SanitizedCaptureBundle
{
