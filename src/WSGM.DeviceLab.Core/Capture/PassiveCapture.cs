...
public interface ICaptureReceiptClock
{
...
public sealed class QpcCaptureReceiptClock : ICaptureReceiptClock
{
    /// <inheritdoc/>
...
public sealed class PassiveCaptureTimeline
{
...
public interface IPassiveCaptureSource
{
...
public sealed class PassiveCaptureCoordinator
{
    ...
    public async Task RunAsync(ObserveOnlyRecipe recipe, CancellationToken cancellationToken)
    {
        ...
        if (recipe.SchemaVersion != CaptureSchema.RecipeVersion
            || recipe.Authority is not RecipeAuthority.InertEvidence
...
public enum GuidedOperatorMarkerKind
{
...
public enum GuidedAxisPosition
{
...
public static class GuidedOperatorMarkers
{
...
/// <summary>Explicit limitations attached to passive Device Lab evidence.</summary>
public static class PassiveCaptureLimitations
{
    ...
    [
        ...
        "Timing correlation is evidence, not proof of causality.",
    ];
}
