...
public enum CaptureBundleReadFailure
{
...
public sealed record CaptureBundleReadResult
{
...
public static class CaptureBundleReader
{
    ...
    public static CaptureBundleReadResult Read(Stream source)
    {
        ...
        try
        {
            ...
            {
                content[path] = ReadEntry(entry);
            }

            if (!TryVerifyHashes(content, out Dictionary<string, string> hashes, out string? hashError))
            {
            ...
            EvidenceClaim[] claims = Deserialize(
                content[CaptureBundleLayout.ClaimsPath],
            ...
            HashSet<string> declared = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                CaptureBundleLayout.ClaimsPath,
...
public sealed record CaptureInspection
{
    ...
    /// <summary>Number of evidence claims.</summary>
...
public static class CaptureWorkbench
{
    ...
    public static CaptureInspection Inspect(SanitizedCaptureBundle bundle)
    {
        ...
        return new CaptureInspection
        {
            ...
            ClaimCount = bundle.Claims.Count,
    ...
    /// <summary>Compares verified archive-entry hashes without interpreting similarity as evidence.</summary>
...
public sealed record CaptureEntryDifference(string Path, string? LeftSha256, string? RightSha256);
