...
public enum DeviceLabOutputTargetKind
{
...
public enum DeviceLabOutputPathRisk
{
...
public sealed record DeviceLabPathBoundaries
{
...
public sealed record DeviceLabOutputPathDecision
{
...
public static class DeviceLabOutputPathPolicy
{
...
public static class DeviceLabRepositoryLocator
{
