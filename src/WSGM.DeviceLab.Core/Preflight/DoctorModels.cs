...
public enum DeviceLabDoctorStatus
{
...
public sealed record DeviceLabDoctorCheck
{
...
public sealed record DeviceLabDoctorReport
{
...
public sealed record WindowsApiAvailability
{
...
public sealed record DeviceLabDoctorSnapshot
{
    ...
    public required bool? IsDeveloperModeEnabled { get; init; }
