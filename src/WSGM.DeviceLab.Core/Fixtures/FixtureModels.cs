...
public sealed record FixtureManifest
{
    ...
    /// <summary>Evidence claims this fixture exercises.</summary>
...
public enum FixtureReplayPolicy
{
...
public static class FixtureSchemaValidator
{
    ...
    public static IReadOnlyList<CaptureValidationError> Validate(FixtureManifest manifest)
    {
        ...
        foreach (string claimId in manifest.ClaimIds)
        {
            ValidateIdentifier(claimId, "fixture.claimIds", errors);
            if (!claimIds.Add(claimId))
            {
                errors.Add(new("fixture.claimIds", $"Claim ID '{claimId}' is duplicated."));
            }
        }
