...
/// <summary>
///     The gamepad-driven SD-card library manager, hosted as a Tools sub-view of
...
public sealed class CardManagerView : OverlaySubView
{
    ...
    {
        _ = RunSafelyAsync(RenderCardListAsync(), "card list");
    }
    ...
    private async Task OpenGameListAsync(LibraryTabManager.CardView card)
    {
        ...
        Replace(() =>
        {
            ...
            {
                stack.Children.Add(Row(names.TryGetValue(id, out var nm)
                    ? nm
