...
/// <summary>
///     The sheet's controller-friendly master-volume and default-device
///     panel. It remains a separate top-level window so combo-box popups and focus
///     traversal work while the sheet is visible underneath.
/// </summary>
public partial class AudioWindow : Window
{
    ...
    /// <summary>
    ///     Places the panel just above the right-hand status section of the
    ///     taskbar and scales it back to the user's normal desktop DPI.
    /// </summary>
