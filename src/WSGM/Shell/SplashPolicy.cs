...
internal static class SplashPolicy
{
    ...
    /// <summary>
    ///     Whether the splash should close because Big Picture never appeared.
    ...
    ///     from the cover would fire in the middle of exactly the wait the cover exists for.
    /// </summary>
    ...
    internal static bool ShouldTimeout(bool armed, TimeSpan sinceArmed)
    {
        return armed && sinceArmed > SteamTimeout;
    }
}
