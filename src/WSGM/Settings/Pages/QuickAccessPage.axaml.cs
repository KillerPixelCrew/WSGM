...
/// <summary>
///     The Quick access settings page: the sheet test launcher, the
...
///     are reached through the visual tree's TopLevel.
/// </summary>
public partial class QuickAccessPage : UserControl
{
    ...
    private void OnRecordChord(object? sender, RoutedEventArgs e)
    {
        Host?.RecordChord();
    }
