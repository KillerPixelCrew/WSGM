...
/// <summary>
///     Editable placement of one boot-splash element. Writes through to the
...
///     or theme import and re-raises every property.
/// </summary>
public sealed class SplashPlacementEditor : ObservableObject
{
    ...
    /// <summary>
    ///     Gets or sets how the element is positioned. Also switches which
    ///     field group (<see cref="IsAnchor" />/<see cref="IsAbsolute" />) the editor shows.
    /// </summary>
    ...
    public int PaddingX
    {
        get => _placement.PaddingX;
        set
        {
            _placement.PaddingX = value;
    ...
    public int PaddingY
    {
        get => _placement.PaddingY;
        set
        {
            _placement.PaddingY = value;
