...
public static class Icons
{
    ...
    /// <summary>
    ///     Six-point snowflake (hibernate). Deliberately not the power symbol:
    ///     hibernate sits next to Shut down in the Power tab, and sharing that glyph made
    ///     the two rows read as the same action.
    /// </summary>
    ...
    /// <summary>
    ///     SD/memory card: rounded body with a clipped top-right corner and
    ///     three contact pins.
    /// </summary>
