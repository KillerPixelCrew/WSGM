...
/// <summary>
///     Decides whether this configuration needs WSGM to run elevated.
...
///     sign-in start of the same configuration land at different integrity levels.
/// </summary>
public static class ElevationPolicy
{
    ...
    /// <param name="steamAlreadyElevated">
    ///     Whether a running or configured Steam is elevated;
    ///     supplied by the caller because reading it enumerates processes.
    /// </param>
    ...
    {
        return ElevationReason(config, steamAlreadyElevated) is not null;
    }
}
