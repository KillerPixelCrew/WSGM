...
{
    /// <summary>Marks a fault on <paramref name="task"/> as observed, so an abandoned cancellation or
    /// timed-out worker never surfaces later as an unobserved task exception.</summary>
