...
public static class PowerActions
{
    ...
    {
        Observe(() => WindowsPower.SuspendAsync(false), "standby");
    }

    /// <summary>Requests hibernation without blocking the UI.</summary>
    public static void Hibernate()
    {
        Observe(() => WindowsPower.SuspendAsync(true), "hibernate");
    }

    /// <summary>Requests a Windows restart.</summary>
    public static void Restart()
    {
        Observe(() => WindowsPower.RequestActionAsync(WindowsPowerAction.Restart), "restart");
    }
