...
/// <summary>
///     Factories for the built-in splash presets. A preset only fills a
///     <see cref="SplashConfig" /> with starting values — every field stays ordinary
///     user-editable configuration afterwards, and no preset fabricates image assets.
/// </summary>
internal static class SplashPresets
{
    ...
    private static SplashConfig Classic()
    {
        return new SplashConfig();
    }

    /// <summary>
    ///     Black background, large centered "WSGM" title with a "STARTING STEAM"
    ///     caption and a small white ring spinner riding the text stack.
    /// </summary>
    private static SplashConfig Wordmark()
    {
        return new SplashConfig
        {
            Text = "WSGM",
    ...
    /// <summary>
    ///     Near-black vignetted background with a small "WSGM" mark and a large
    ///     accent-orange ring spinner drawn around the centered text block.
    /// </summary>
    private static SplashConfig MonogramRing()
    {
        return new SplashConfig
        {
            Text = "WSGM",
    ...
    /// <summary>
    ///     Minimal quiet look: a dim "Starting Steam" line with a tiny ring
    ///     spinner, anchored toward the bottom of an almost-black screen. (The mockup's
    ///     corner brand mark needs a user-supplied logo image; presets never fabricate one.)
    /// </summary>
    private static SplashConfig QuietConsole()
    {
        return new SplashConfig
        {
            Text = "Starting Steam",
    ...
    /// <summary>
    ///     Black background, centered "WSGM" wordmark, and an accent-orange
    ///     sweep-line spinner traveling along the bottom edge.
    /// </summary>
    private static SplashConfig SweepLine()
    {
        return new SplashConfig
        {
            Text = "WSGM",
