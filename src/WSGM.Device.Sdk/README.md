...
repository covers the unattended half — lifecycle, capability and manifest behaviour with no
hardware attached.
...
The host does not assume equal sustained and boost values. See the reference guide's version
history.
