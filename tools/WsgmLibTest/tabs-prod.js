...
window.__wsgm.tabs=[{id:"wsgm-e",title:"E: Library",appids:[22600,31280,70600]},{id:"wsgm-d",title:"D: Library",appids:[293760,1623730,3602290]}];
if(window.__wsgm.forceRerender)window.__wsgm.forceRerender();
return JSON.stringify({ok:true,installed:!!window.__wsgm.tabsInstalled,count:(window.__wsgm.tabs||[]).length});
